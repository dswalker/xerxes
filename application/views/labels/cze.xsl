...
-->
	...
	<xsl:variable name="text_results_format_article">článek</xsl:variable>
	...
	<xsl:variable name="text_results_format_computer_file">počítačový soubor</xsl:variable>
	<xsl:variable name="text_results_format_conference_paper">příspevek do konference</xsl:variable>
	<xsl:variable name="text_results_format_conference_proceeding">sborník z konference</xsl:variable>
	<xsl:variable name="text_results_format_dissertation">dizertační práce</xsl:variable>
	...
	<xsl:variable name="text_results_format_journal">odborný časopis</xsl:variable>
	<xsl:variable name="text_results_format_journal_or_newspaper">časopis nebo noviny</xsl:variable>
	<xsl:variable name="text_results_format_journal_article">článek v odborném časopise</xsl:variable>
	<xsl:variable name="text_results_format_magazine_article">článek v časopise</xsl:variable>
	...
	<xsl:variable name="text_results_format_newspaper_article">článek v novinách</xsl:variable>
	...
	<xsl:variable name="text_results_format_thesis">kvalifikační práce</xsl:variable>
	...
	<xsl:variable name="text_results_format_case">případ</xsl:variable>
	...
	<xsl:variable name="text_results_format_journal___ejournal">odborný časopis / eČasopis</xsl:variable>
	<xsl:variable name="text_results_format_magazine">časopis</xsl:variable>
	<xsl:variable name="text_results_format_manuscript">rukopis</xsl:variable>
	<xsl:variable name="text_results_format_market_research">průzkum trhu</xsl:variable>
	...
	<xsl:variable name="text_results_format_poem">báseň</xsl:variable>
	...
	<xsl:variable name="text_results_format_reference">příručka</xsl:variable>
	...
	<xsl:variable name="text_results_format_trade_publication_article">článek v obchodní publikaci</xsl:variable>
